...
print()
print("Проходя сквозь темные коридоры, вы находите сокровище! Однако, в порыве спешки за сокрофищем, вы замечаете робота, который его охраняет")
print("Ну, как вас и учили, ели в подземелье вам не дают сокровище, надо его отнять! Вперёд в бой!")
input("Нажимте Enter чтобы продолжить")
print("В бой!")
